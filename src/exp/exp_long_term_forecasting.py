from ..datamodule.data_factory import data_provider
from .exp_basic import Exp_Basic
from ..utils.train import EarlyStopping, adjust_learning_rate, visual
...
base_root = "/home/user/data/Benchmarks"
...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def test(self, setting, test=0):
        ...
        # result save
        folder_path = base_root + "/metric_results/" + setting + "/"
        if not os.path.exists(folder_path):
            os.makedirs(folder_path)
