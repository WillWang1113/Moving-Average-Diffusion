...
$$\mathbf{\tilde{x}}_{t-1} = \sqrt{{\frac{\beta_{t-1}^2 - \sigma_t^2}{\beta_t^2}}} \mathbf{\tilde{x}}_t + (\mathbf{\tilde{K}}_{t-1} - \sqrt{{\beta_{t-1}^2 - \frac{\sigma_t^2}{\beta_t^2}}} \mathbf{\tilde{K}}_t) \mathbf{\tilde{x}}_0  + \sigma_t \epsilon^\prime, \epsilon^\prime \sim \mathcal{CN}(0, \mathbf{I})$$
