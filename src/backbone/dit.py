...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        self.x_embedder = PatchEmbed(seq_length, patch_size, seq_channels, d_model, bias=True)
    ...
    def unpatchify(self, x):
        ...
        num_patch = self.seq_len // self.patch_size
    ...
    def forward(self, x, t, condition):
        ...
        """
        x = self.x_embedder(x) + self.pos_embed  # (N, T, D), where T = (seq_len / patch_size)
