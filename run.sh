...
model_config=MADtime_pl_FactOnly_FreqDoi
  ...
  for i in "${pred_len[@]}"; do
    for j in "${data_pth[@]}"; do
      ...
      python scripts/sample_pl.py \
        ...
        --deterministic \
        --n_sample 100 \
        --gpu $gpu --num_train 5 --init_model $init_model --start_ks 4
    done
  done
done

# # full step + stride=factor + Frequency denoise
# gpu=1
# batch_size=(128 256 64)
# model_config=MADtime_pl_Full_SETKS_FreqDoi
# save_dir=/home/user/data/FrequencyDiffusion/savings
# # save_dir=/mnt/ExtraDisk/wcx/research/FrequencyDiffusion/savings
...
#         --deterministic \
#         --n_sample 100 \
#         --gpu $gpu --num_train 5 --fast_sample
#     done
#   done
# done
